...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agg_daily_admission_refusals_org_code"), "agg_daily_admission_refusals", ["org_code"], unique=False
    )
    op.create_index(
        op.f("ix_agg_daily_admission_refusals_region_code"),
        "agg_daily_admission_refusals",
        ["region_code"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agg_daily_hospital_profile_org_code"), "agg_daily_hospital_profile", ["org_code"], unique=False
    )
    op.create_index(
        op.f("ix_agg_daily_hospital_profile_profile_code"), "agg_daily_hospital_profile", ["profile_code"], unique=False
    )
    op.create_index(
        op.f("ix_agg_daily_hospital_profile_region_code"), "agg_daily_hospital_profile", ["region_code"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_agg_daily_region_profile_profile_code"), "agg_daily_region_profile", ["profile_code"], unique=False
    )
    op.create_index(
        op.f("ix_agg_daily_region_profile_region_code"), "agg_daily_region_profile", ["region_code"], unique=False
    )
    op.create_table(
        "dim_profile",
        sa.Column("profile_code", sa.String(length=8), nullable=False),
    ...
    op.create_index(
        op.f("ix_fact_admission_refusal_refuse_date"), "fact_admission_refusal", ["refuse_date"], unique=False
    )
    op.create_index(
        op.f("ix_fact_admission_refusal_region_code"), "fact_admission_refusal", ["region_code"], unique=False
    )
    op.create_table(
        "fact_referral",
    ...
    op.create_index(
        op.f("ix_fact_referral_hospital_region_code"), "fact_referral", ["hospital_region_code"], unique=False
    )
    op.create_index(
        op.f("ix_fact_referral_hospitalization_code"), "fact_referral", ["hospitalization_code"], unique=False
    )
    op.create_index(
        op.f("ix_fact_referral_hospitalization_date"), "fact_referral", ["hospitalization_date"], unique=False
    )

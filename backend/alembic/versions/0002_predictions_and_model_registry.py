...
def upgrade() -> None:
    ...
    op.create_table('pred_daily_forecast',
    ...
    op.create_index(op.f('ix_pred_referral_hospitalization_code'), 'pred_referral', ['hospitalization_code'], unique=False)

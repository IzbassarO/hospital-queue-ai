...
def upgrade() -> None:
    ...
    op.create_table('mart_area_status',
    ...
    op.create_table('mart_build_info',
    ...
    op.create_table('mart_hospital_profile_status',
    sa.Column('org_code', sa.String(length=8), nullable=False),
    sa.Column('profile_code', sa.String(length=8), nullable=False),
    sa.Column('region_code', sa.String(length=4), nullable=False),
    ...
    op.create_index('ix_mart_hps_region_profile', 'mart_hospital_profile_status', ['region_code', 'profile_code'], unique=False)
    op.create_table('mart_region_profile_status',
    sa.Column('region_code', sa.String(length=4), nullable=False),
    sa.Column('profile_code', sa.String(length=8), nullable=False),
    sa.Column('region_name', sa.Text(), nullable=False),
    sa.Column('profile_name', sa.Text(), nullable=False),

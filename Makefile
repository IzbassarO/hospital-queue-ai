...
.PHONY: up down migrate ingest baseline psql train tournament flow-evidence flow-quantile flow-calibration predict registry marts create-key backup restore api-dev test ml-test \
